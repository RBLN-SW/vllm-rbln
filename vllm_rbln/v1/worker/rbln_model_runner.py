...
class RBLNModelRunner(KVConnectorModelRunnerMixin):
    ...
    def run_model_graphs(self) -> None:
        ...
        A dynamic-KV resize replaces the KV tensors under graphs already built,
        so it runs this again: a graph left unrun re-latches its adaptive buffers
        and repatches the moved KV addresses on the first request to reach it.
        """
        # 1. prefill
