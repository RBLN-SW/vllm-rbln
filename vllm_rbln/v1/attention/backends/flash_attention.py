...
class RBLNFlashAttentionMetadata:
    ...
    kv_cache_bases: list[torch.Tensor] | None = None
...
class RBLNFlashAttentionMetadataBuilder(
    ...
    def build(
        ...
        # num_computed_tokens_cpu is already on CPU → no .cpu() needed.
        is_prefills = num_computed_tokens_cpu.numpy() < num_tokens[:num_reqs] - 1
