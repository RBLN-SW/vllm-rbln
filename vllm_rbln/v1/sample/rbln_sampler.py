...
def resolve_compile_context(
    ...
    # Set BOTH use_weight_sharing and use_global_ctx when supported. Returning on
    # the first matching flag dropped use_weight_sharing, which broke weight-free
    # meta-const materialization (MetaConstDescriptorGen: "constant data not
    # materialized" at prefill compile). Pass both.
