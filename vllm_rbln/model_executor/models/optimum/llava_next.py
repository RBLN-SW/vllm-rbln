    ...
    def forward(self, model_input: ModelInputForRBLN, **kwargs) -> torch.Tensor:
        ...
        if not is_prompt:
            ...
            if model_input.cached_block_tables:
                print("@@@ cached_block_tables", model_input.cached_block_tables)
                print("@@@ cached_lengths", model_input.cached_lengths)
                print("@@@ model_input.block_tables", model_input.block_tables)
