...
def register_model():
    # Optimum-rbln model registrations were removed along with the optimum
    # codepath. Native vLLM models are registered via register_ops().
    return
...
def register_ops():
    ...
    import vllm_rbln.model_executor.model_loader._dummy_weights_rbln  # noqa
