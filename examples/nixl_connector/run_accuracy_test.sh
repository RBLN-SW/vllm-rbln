...
run_tests_for_model() {
  ...
  PROXY_CMD="python3 ${GIT_ROOT}/examples/nixl_connector/toy_proxy_server.py --port 8192"
  ...
  TEST_MODEL=$model_name python3 -m pytest -s -x ${GIT_ROOT}/examples/nixl_connector/test_accuracy.py
