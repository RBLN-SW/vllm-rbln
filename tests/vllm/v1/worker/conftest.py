...
# The suite conftest's pytest_configure sets VLLM_RBLN_USE_VLLM_MODEL=1, and
...
def make_model_runner():
    ...
    from tests.vllm.v1.worker.utils import make_kv_cache_config, make_runner_config
