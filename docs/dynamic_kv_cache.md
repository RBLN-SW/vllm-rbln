...
| `VLLM_RBLN_COMPILE_KV_CACHE_NUM_BLOCKS` | derived (`8`) | Debug override of the compile-time block count. `0` opts out of the shrink, and therefore out of the resize. |
